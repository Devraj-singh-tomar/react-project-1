...
const Footer = () => {
    return (
        <div className='w-full h-screen flex gap-5 bg-zinc-900 px-20 py-16'>
            <div className="w-1/2 h-full flex flex-col justify-between">
                <div className="heading">
                    <h1 className='text-[5vw] uppercase font-semibold leading-none '>Eye-</h1>
                    <h1 className='text-[5vw] uppercase font-semibold leading-none '>Opening</h1>
                </div>
            ...
            <div className="w-1/2">
                <h1 className='text-[5vw] uppercase font-semibold leading-none '>Prensentations
                </h1>
